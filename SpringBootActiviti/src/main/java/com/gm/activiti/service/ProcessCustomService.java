package com.gm.activiti.service;
...
public class ProcessCustomService {
	 ...
	 * findProcessDefinitionEntityByTaskId(taskId); InputStream imageStream =
	 * ProcessDiagramGenerator.generateDiagram( pde, "png",
	 * runtimeService.getActiveActivityIds
	 * (findProcessInstanceByTaskId(taskId).getId())); return imageStream; }
	 */
